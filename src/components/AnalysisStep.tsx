  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-6 space-y-12">
      <div className="flex justify-between items-end">
        ...
        <button
          onClick={onNext}
          className="bg-brand-accent text-white px-8 py-3 rounded-xl font-display uppercase font-bold tracking-wider flex items-center gap-2 hover:bg-brand-accent/90 transition-all shadow-lg shadow-brand-accent/20"
        >
