...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg selection:bg-brand-accent/20 border-[4px] border-border" style={{ backgroundColor: 'var(--color-brand-bg)' }}>
      {/* Navigation Header */}
      <nav className="bg-background sticky top-0 z-50" style={{ backgroundColor: 'var(--color-background)', borderBottom: '4px solid var(--color-border)' }}>
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-xl uppercase tracking-wider select-none">RoomStory</span>
          </div>
