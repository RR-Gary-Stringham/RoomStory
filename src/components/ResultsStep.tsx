  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-6 space-y-12">
      <div className="flex justify-between items-end">
        ...
        <button
          onClick={onExport}
          className="bg-brand-ink text-white px-8 py-3 rounded-xl font-display uppercase font-bold tracking-wider flex items-center gap-2 hover:bg-black transition-all shadow-lg"
        >
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="glass-panel rounded-2xl p-8 space-y-8">
            ...
            <div className="space-y-4 pt-6 border-t border-black/5">
              ...
              <button className="w-full py-3 rounded-xl bg-brand-accent/5 text-brand-accent text-xs font-display font-bold uppercase tracking-widest hover:bg-brand-accent/10 transition-all">
                Match Lighting & Tone
              </button>
            </div>
            ...
            {!selected.isVerified && (
              <div className="p-6 bg-amber-50 rounded-2xl border border-amber-200 space-y-4">
                ...
                <button 
                  ...
                  className="w-full py-3 bg-amber-600 text-white rounded-xl text-xs font-display font-bold uppercase tracking-widest hover:bg-amber-700 transition-all shadow-md shadow-amber-600/20"
                >
                  Confirm as Accurate
                </button>
              </div>
