  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-12">
      <div className="text-center space-y-4">
        <h1 className="text-6xl font-display uppercase font-bold tracking-tight">RoomStory AI</h1>
        <p className="text-brand-ink/60 max-w-xl mx-auto text-lg font-serif">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-6">
          <div 
            {...getRootProps()} 
            className={cn(
              "aspect-[4/3] bg-card border-2 border-dashed rounded-2xl flex flex-col items-center justify-center cursor-pointer transition-all overflow-hidden relative group",
        ...
        <div className="space-y-8">
          ...
          <button
            ...
            className={cn(
              "w-full py-4 rounded-xl font-display uppercase font-bold tracking-wider flex flex-col items-center justify-center gap-1 transition-all",
              !file || isLoading
