    ...
    <div className="max-w-3xl mx-auto py-24 px-6 text-center space-y-12">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
        <button
          ...
          className="bg-brand-accent text-white px-12 py-4 rounded-xl font-display uppercase font-bold tracking-wider flex items-center justify-center gap-2 hover:bg-brand-accent/90 transition-all shadow-xl shadow-brand-accent/20"
        >
          <Download className="w-5 h-5" /> Download ZIP Package
        </button>
        <button
          onClick={onReset}
          className="bg-white border border-black/10 text-brand-ink px-12 py-4 rounded-xl font-display uppercase font-bold tracking-wider flex items-center justify-center gap-2 hover:bg-black/5 transition-all"
        >
